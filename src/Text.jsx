  ...
  return (
    <div className='min-h-screen'>
      <div className='container mx-auto px-4 '>
        ...
        />
        <div className='lg:h-[700px] h-screen rounded-t-2xl shadow-2xl'>
          <div className='h-full relative'>
            ...
            {isTyping && (
              <p className='absolute bottom-0 left-0 italic text-gray-700 m-4 font-semibold mb-20'>
                Mr.blue is typing...
              </p>
            )}
            <div className='container mx-auto px-4 pr-7 fixed lg:relative bottom-0 w-auto lg:w-auto bg-gray-900 rounded-b-xl lg:rounded-b-none border-t-l-gray-500 py-2 lg:border '>
              <form
